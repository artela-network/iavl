...
func NewImmutableTree(db dbm.DB, cacheSize int, skipFastStorageUpgrade bool, name string) *ImmutableTree {
	if db == nil {
		// In-memory Tree.
	...
	return &ImmutableTree{
		// NodeDB-backed Tree.
		ndb:                    newNodeDB(db, cacheSize, nil, name),
		skipFastStorageUpgrade: skipFastStorageUpgrade,
	}
}

// NewImmutableTreeWithOpts creates an ImmutableTree with the given options.
func NewImmutableTreeWithOpts(db dbm.DB, cacheSize int, opts *Options, skipFastStorageUpgrade bool, name string) *ImmutableTree {
	return &ImmutableTree{
		// NodeDB-backed Tree.
